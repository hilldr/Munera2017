...
#! /bin/bash
cuffmerge -g $GENES -s $GENOME -p 8 -o ../DATA/merged_asm EGF-Noggin-BMP_adult_assembly.txt
for d in ../DATA/BAM/*/
do
    FILENAME="$file"       #set variable FILENAME equal to file from line 1
    SHORTNAME=$(basename "$file")
...
mkdir ../RESULTS
# CUFFNORM
cuffnorm -o ../RESULTS/EGF-Noggin-BMP_adult_normout -p 8 -L Noggin-TXP,BMP-TXP,adult-SI,adult-colon,EGF-TXP ../DATA/merged_asm/merged.gtf \
...
# Run R script
Rscript EGF-Noggin-BMP_adult.R
